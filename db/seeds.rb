...
z3 = Account.create(user_id: zoe.id, account_type_id: checking.id, active: true, starting_balance: 150.00)
z4 = Account.create(user_id: zoe.id, account_type_id: saving.id, active: true, starting_balance: 150.00)

k1 = Account.create(user_id: kenny.id, account_type_id: cash.id, active: true, starting_balance: 200.00)
k2 = Account.create(user_id: kenny.id, account_type_id: credit.id, active: true, starting_balance: 200.00)
k3 = Account.create(user_id: kenny.id, account_type_id: checking.id, active: true, starting_balance: 200.00)
k4 = Account.create(user_id: kenny.id, account_type_id: saving.id, active: false)

b1 = Account.create(user_id: brian.id, account_type_id: cash.id, active: true, starting_balance: 300.00)
b2 = Account.create(user_id: brian.id, account_type_id: credit.id, active: false)
b3 = Account.create(user_id: brian.id, account_type_id: checking.id, active: true, starting_balance: 300.00)
b4 = Account.create(user_id: brian.id, account_type_id: saving.id, active: false)
